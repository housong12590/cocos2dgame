...
//                cxqItem.setScale(0.5);
                cxqItem.setPosition(size.width/2 - 150, size.height/2 + 100 - 50); // 曹雪芹
...
//                lgzItem.setScale(0.5);
                lgzItem.setPosition(size.width/2 + 150, size.height/2 + 100 - 50); // 罗贯中
...
//                snaItem.setScale(0.5);
                snaItem.setPosition(size.width/2 - 150, size.height/2 - 100 - 50 + 20); // 施耐庵
...
//                wceItem.setScale(0.5);
                wceItem.setPosition(size.width/2 + 150, size.height/2 - 100 - 50 + 20); // 吴承恩
